...
console.log(App); // loadされると、以下のjsが発火する

document.addEventListener('DOMContentLoaded', function () {
  new vue__WEBPACK_IMPORTED_MODULE_0__["default"]({
    el: '#app',
    components: {
      AppTemp: _javascript_app_vue__WEBPACK_IMPORTED_MODULE_1__["default"]
    },
    data: {
      searchQuery: '',
      messages: [],
...
/******/ });
//# sourceMappingURL=application-3e0d6db5e0321ea4f15d.js.map
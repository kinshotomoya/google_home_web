  ...
  methods: {
    searchMemberTalk: function searchMemberTalk() {
      ...
      if (name === '') {
        ...
        store.dispatch('doChangeSearchName', null); // this.$store.commit('setSearchName', null)
      } else {
        // this.$store.commit('setSearchName', this.searchQuery)
        store.dispatch('doChangeSearchName', this.searchQuery);
      }
...
/******/ });
//# sourceMappingURL=header_temp-33fd9a8bb9021690a8fa.js.map
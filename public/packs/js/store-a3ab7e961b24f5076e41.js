...
/******/ 	return __webpack_require__(__webpack_require__.s = "./app/javascript/packs/store.js");
/******/ })
/************************************************************************/
/******/ ({
...
var store = new vuex__WEBPACK_IMPORTED_MODULE_1__["default"].Store({
  ...
  mutations: {
    // methodsみたいなもの
    setSearchName: function setSearchName(state, payload) {
      // payloadは、commitからの引数
      state.searchName = payload;
    },
    setMessages: function setMessages(state, payload) {
      state.messages = payload;
    },
    setHeaderTitle: function setHeaderTitle(state, payload) {
      state.headerTitle = payload;
    },
    loadStart: function loadStart(state) {
      state.loading = true;
      console.log(state.loading);
    },
    loadEnd: function loadEnd(state) {
      state.loading = false;
    }
  },
  actions: {
    // 非同期で行いたいアクションを指定する。基本的にdispatchでアクションを指定する！！！
    doChangeSearchName: function doChangeSearchName(_ref, searchName) {
      var commit = _ref.commit;
      commit('setSearchName', searchName);
    },
    doAddMessages: function doAddMessages(_ref2, messages) {
      var commit = _ref2.commit;
      // messagesには、サーバーサイドから取得したmessageの配列が格納されている
      commit('setMessages', messages);
    },
    doChangeHeaderTitle: function doChangeHeaderTitle(_ref3, title) {
...
/******/ });
//# sourceMappingURL=store-a3ab7e961b24f5076e41.js.map
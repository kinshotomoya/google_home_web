...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  created: function created() {
    console.log(this.$store.state.count); // storeを呼び出すことができる

    this.$store.commit('increment'); // commitもできる

    console.log(this.$store.state.count); // きちんと更新できている
...
/******/ });
//# sourceMappingURL=header_temp-b57396e9e3c3a605c398.js.map